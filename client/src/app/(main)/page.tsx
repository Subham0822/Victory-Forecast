    ...
    <div className="space-y-12 relative z-10">
      ...
      <div className="space-y-6 relative">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight">
              <AnimatedText 
                text="Welcome to Esports Oracle" 
                variant="glow"
                className="block"
              />
            </h1>
        ...
        <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
          Leverage the power of <span className="text-primary font-semibold">AI</span> to get predictions and insights for your favorite esports titles. Select a tool below to get started.
        </p>
      </div>
