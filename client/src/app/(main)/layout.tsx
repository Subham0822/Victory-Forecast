...
import { BrainCircuit, Swords, Gamepad2, Shield, Sparkles, Wand2 } from "lucide-react";
import {
  SidebarProvider,
  Sidebar,
  SidebarHeader,
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <Link href="/" className={cn(
                ...
                <Gamepad2 size={18} className="transition-transform duration-300 group-hover:rotate-12" />
                <span>Dashboard</span>
              </Link>
            </SidebarMenuItem>
            ...
            <SidebarGroup>
                ...
                <SidebarMenuItem>
                    <Link href="/valorant/team-vs-team" className={cn(
                      "flex items-center gap-2 transition-all duration-300",
                      "hover:text-primary hover:translate-x-1"
                    )}>
                ...
                <SidebarMenuItem>
                    <Link href="/csgo/team-vs-team" className={cn(
                      "flex items-center gap-2 transition-all duration-300",
                      "hover:text-primary hover:translate-x-1"
                    )}>
                ...
                <SidebarMenuItem>
                    <Link href="/pubg/player-placement" className={cn(
                      "flex items-center gap-2 transition-all duration-300",
                      "hover:text-primary hover:translate-x-1"
                    )}>
                ...
                <SidebarMenuItem>
                    <Link href="/league-of-legends/match-prediction" className={cn(
                      "flex items-center gap-2 transition-all duration-300",
                      "hover:text-primary hover:translate-x-1"
                    )}>
            ...
            <SidebarGroup>
                ...
                <SidebarMenuItem>
                    <Link href="/team-name-generator" className={cn(
                      "flex items-center gap-2 transition-all duration-300",
                      "hover:text-primary hover:translate-x-1"
                    )}>
